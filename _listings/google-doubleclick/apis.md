...
- name: Google Doubleclick API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-doubleclick/master/_listings/google-doubleclick/reports-reportid-files-reportfragment-get.md
x-common:
